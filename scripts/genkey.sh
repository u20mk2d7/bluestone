...
openssl genpkey -algorithm ed25519 -out ../.env/private_key.pem

# 2. Extract the matching public key file
openssl pkey -in ../.env/private_key.pem -pubout -out ../.env/public-key.pem

openssl pkey -in ../.env/private_key.pem -outform DER | tail -c 32 > ../.env/raw_seed.bin && \
